object Dependencies {
    ...
    object Jetpack {
        ...
        const val composeFoundation = "androidx.compose.foundation:foundation:${Versions.Jetpack.COMPOSE_UI}"
        const val composeRuntime = "androidx.compose.runtime:runtime:${Versions.Jetpack.COMPOSE_UI}"
        ...
        const val composeViewModel = "androidx.lifecycle:lifecycle-viewmodel-compose:${Versions.Jetpack.COMPOSE_VIEW_MODEL}"
    }
